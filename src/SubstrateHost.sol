...
library SubstrateHost {
    ...
    address public constant POST_REQUEST_DISPATCHER =
        0x222A98a2832ae77E72a768bF5be1F82D8959f4Ec;
    address public constant POST_RESPONSE_DISPATCHER =
        0xEB928e2de75Cb5ab60aBE75f539C5312aeb46f38;
    address public constant GET_REQUEST_DISPATCHER =
    ...
    function dispatch(DispatchPost memory request) internal view {
        ...
        (bool ok, bytes memory out) = address(POST_REQUEST_DISPATCHER)
            .staticcall(input);
    ...
    function dispatch(DispatchGet memory request) internal view {
        ...
        (bool ok, bytes memory out) = address(GET_REQUEST_DISPATCHER)
            .staticcall(input);
    ...
    function dispatch(PostResponse memory response) internal view {
        ...
        (bool ok, bytes memory out) = address(POST_RESPONSE_DISPATCHER)
            .staticcall(input);
